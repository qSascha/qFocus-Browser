...
struct iPadGreasyWizard2: View {
    ...
    var body: some View {
        iPadGreasyWebViewRepresentable(
        ...
        .navigationDestination(isPresented: $showEditView) {
            iPadOptionsGreasyEdit(scriptObject: nil, greasyRepo: greasyRepo, sitesRepo: sitesRepo, newScript: newScript)
        }
        .onAppear() {
...
struct iPadGreasyWebViewRepresentable: UIViewRepresentable {
